...
export const EVENTS_INFO: {
  ...
  [ChainId.BSC_MAINNET]: [
    {
      ...
      desc:
        'You win if you correctly guess the price of BTC. Will it be higher or lower then $52,400 USD at 11 September 23:59 UTC? Witdraw from this pool',
  ...
  ],
 {
      ...
      desc:
        'You win if you correctly guess the price of BTC. Will it be higher or lower then $52,400 USD at 11 September 23:59 UTC? Deposit the NEW pool',
